...
$path_to_spark/bin/spark-submit --driver-memory 10g --class paristech.Preprocessor target/scala-2.11/*.jar
$path_to_spark/bin/spark-submit --driver-memory 10g --class paristech.Trainer target/scala-2.11/*.jar
